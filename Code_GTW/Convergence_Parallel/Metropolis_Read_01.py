...
def main():
	...
	chain, acc, max_ps, max_lp = metropolis(paramStart, binV_real, nBin, bound, alpha, weights, pLim, jump_sigma, nStep, param_toFit, outFile, tid)
...
def metropolis(start, data_real, nBin, bound, alpha, weights, pLim, jump_sigma, n, param_toFit, filename, tid):
...
#		print cand
		...
		print cur[param_toFit[0]], cand[param_toFit]
